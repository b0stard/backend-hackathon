...
interface TaskRepository : JpaRepository<Task, Long> {
    ...
    fun findAllByAuthorId(authorId: Long): List<Task>

    fun findAllByPriority(priority: TaskPriority): List<Task>

    fun findAllByStatus(status: TaskStatus): List<Task>

    fun findAllByDeadlineBetween(start: LocalDateTime, end: LocalDateTime): List<Task>

    fun findAllByTitleContainingIgnoreCase(title: String): List<Task>
    ...
    fun findAllByAssigneeIdWithRelations(@Param("assigneeId") assigneeId: Long): List<Task>
